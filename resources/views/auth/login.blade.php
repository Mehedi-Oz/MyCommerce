...
<section id="wrapper">
    <div class="login-register"
         style="background-image:url({{asset('admin-asset')}}/assets/images/background/login-register.jpg);">
                    ...
                    <div class="row">
                        <div class="col-xs-12 col-sm-12 col-md-12 m-t-10 text-center">
                            <div class="social">
                                ...
                                <button class="btn btn-googleplus" data-bs-toggle="tooltip" title="Login with Google"><i
