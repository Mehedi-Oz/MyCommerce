                ...
                <div class="col-lg-8 col-12 custom-padding-right">
                    <div class="slider-head">
                        ...
                        <div class="hero-slider">
                            ...
                            <div class="single-slider" style="background-image: url({{asset('front-end-asset')}}/images/hero/slider-bg1.jpg);">
                                <div class="content">
                            ...
                            <div class="single-slider" style="background-image: url({{asset('front-end-asset')}}/images/hero/slider-bg2.jpg);">
                                <div class="content">
                ...
                <div class="col-lg-4 col-12">
                    <div class="row">
                        <div class="col-lg-12 col-md-6 col-12 md-custom-padding">
                            ...
                            <div class="hero-small-banner" style="background-image: url('{{asset('front-end-asset')}}/images/hero/slider-bnr.jpg');">
                                <div class="content">
                                    <h2>
            ...
            <div class="row">
                <div class="col-lg-4 col-md-6 col-12">
                    ...
                    <div class="single-category">
                        ...
                        <div class="images">
                            <img src="{{asset('front-end-asset')}}/images/featured-categories/fetured-item-1.png" alt="#">
                        </div>
                    </div>
                ...
                <div class="col-lg-4 col-md-6 col-12">
                    ...
                    <div class="single-category">
                        ...
                        <div class="images">
                            <img src="{{asset('front-end-asset')}}/images/featured-categories/fetured-item-2.png" alt="#">
                        </div>
                    </div>
                ...
                <div class="col-lg-4 col-md-6 col-12">
                    ...
                    <div class="single-category">
                        ...
                        <div class="images">
                            <img src="{{asset('front-end-asset')}}/images/featured-categories/fetured-item-3.png" alt="#">
                        </div>
                    </div>
                ...
                <div class="col-lg-4 col-md-6 col-12">
                    ...
                    <div class="single-category">
                        ...
                        <div class="images">
                            <img src="{{asset('front-end-asset')}}/images/featured-categories/fetured-item-4.png" alt="#">
                        </div>
                    </div>
                ...
                <div class="col-lg-4 col-md-6 col-12">
                    ...
                    <div class="single-category">
                        ...
                        <div class="images">
                            <img src="{{asset('front-end-asset')}}/images/featured-categories/fetured-item-5.png" alt="#">
                        </div>
                    </div>
                ...
                <div class="col-lg-4 col-md-6 col-12">
                    ...
                    <div class="single-category">
                        ...
                        <div class="images">
                            <img src="{{asset('front-end-asset')}}/images/featured-categories/fetured-item-6.png" alt="#">
                        </div>
                    </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6 col-md-6 col-12">
                    <div class="single-banner" style="background-image:url('{{asset('front-end-asset')}}/images/banner/banner-1-bg.jpg')">
                        <div class="content">
                ...
                <div class="col-lg-6 col-md-6 col-12">
                    <div class="single-banner custom-responsive-margin" style="background-image:url('{{asset('front-end-asset')}}/images/banner/banner-2-bg.jpg')">
                        <div class="content">
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-8 col-md-12 col-12">
                    ...
                    <div class="single-banner right" style="background-image:url('{{asset('front-end-asset')}}/images/banner/banner-3-bg.jpg');margin-top: 30px;">
                        <div class="content">
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-4 col-md-4 col-12 custom-responsive-margin">
                    ...
                    <div class="single-list">
                        <div class="list-image">
                            <a href="product-grids.html"><img src="{{asset('front-end-asset')}}/images/home-product-list/01.jpg" alt="#"></a>
                        </div>
                        <div class="list-info">
                            <h3>
                    ...
                    <div class="single-list">
                        <div class="list-image">
                            <a href="product-grids.html"><img src="{{asset('front-end-asset')}}/images/home-product-list/02.jpg" alt="#"></a>
                        </div>
                        <div class="list-info">
                            <h3>
                    ...
                    <div class="single-list">
                        <div class="list-image">
                            <a href="product-grids.html"><img src="{{asset('front-end-asset')}}/images/home-product-list/03.jpg" alt="#"></a>
                        </div>
                        <div class="list-info">
                            <h3>
                ...
                <div class="col-lg-4 col-md-4 col-12 custom-responsive-margin">
                    ...
                    <div class="single-list">
                        <div class="list-image">
                            <a href="product-grids.html"><img src="{{asset('front-end-asset')}}/images/home-product-list/04.jpg" alt="#"></a>
                        </div>
                        <div class="list-info">
                            <h3>
                    ...
                    <div class="single-list">
                        <div class="list-image">
                            <a href="product-grids.html"><img src="{{asset('front-end-asset')}}/images/home-product-list/05.jpg" alt="#"></a>
                        </div>
                        <div class="list-info">
                            <h3>
                    ...
                    <div class="single-list">
                        <div class="list-image">
                            <a href="product-grids.html"><img src="{{asset('front-end-asset')}}/images/home-product-list/06.jpg" alt="#"></a>
                        </div>
                        <div class="list-info">
                            <h3>
                ...
                <div class="col-lg-4 col-md-4 col-12">
                    ...
                    <div class="single-list">
                        <div class="list-image">
                            <a href="product-grids.html"><img src="{{asset('front-end-asset')}}/images/home-product-list/07.jpg" alt="#"></a>
                        </div>
                        <div class="list-info">
                            <h3>
                    ...
                    <div class="single-list">
                        <div class="list-image">
                            <a href="product-grids.html"><img src="{{asset('front-end-asset')}}/images/home-product-list/08.jpg" alt="#"></a>
                        </div>
                        <div class="list-info">
                            <h3>
                    ...
                    <div class="single-list">
                        <div class="list-image">
                            <a href="product-grids.html"><img src="{{asset('front-end-asset')}}/images/home-product-list/09.jpg" alt="#"></a>
                        </div>
                        <div class="list-info">
                            <h3>
