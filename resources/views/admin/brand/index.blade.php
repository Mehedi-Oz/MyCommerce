...
@section('body')
    ...
    <div class="row mt-3">
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title">Add A Product Brand</h4> <span class="text-success"> {{session('message')}} </span>
                    ...
                    <form class="form-horizontal p-t-20" action="{{route('brand.new')}}" method="post"
                        ...
                        <div class="form-group row m-b-0">
                            <div class="offset-sm-3 col-sm-9">
                                <button type="submit" class="btn btn-success waves-effect waves-light text-white">Create New Brand
                                </button>
                            </div>
                        </div>
                    </form>
