    ...
    public function index(Request $request)
    {
        ...
        $update_product = DB::table('orders')
            ...
            ->updateOrInsert([
                ...
                'order_timestamp' => strtotime(date('H:i:s')),
    ...
    public function payViaAjax(Request $request)
    {
        ...
        $update_product = DB::table('orders')
            ...
            ->updateOrInsert([
                ...
                'order_timestamp' => $post_data['cus_email'],
                'order_date' => $post_data['cus_phone'],
                'tax_total' => $post_data['cus_phone'],
                'shipping_total' => $post_data['cus_phone'],
                'delivery_address' => $post_data['cus_phone'],
                'payment_type' => $post_data['total_amount'],
                'transaction_id' => $post_data['tran_id'],
                'currency' => $post_data['currency']
            ]);
